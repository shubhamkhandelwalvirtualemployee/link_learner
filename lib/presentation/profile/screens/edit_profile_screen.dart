                            ...
                            setState(() => _gender = val),
                              ...
                              GestureDetector(
                                onTap:
                                    () => _pickDate(
                                      context,
                                      profileProvider.dateOfBirthController,
                                    ),
                                child: AbsorbPointer(
    ...
    children: [
      TextFormField(
        ...
        decoration: InputDecoration(
          hintText: hint ?? '',
          hintStyle: const TextStyle(color: ColorConstants.disabledColor),
  ...
  Widget _underlinedPhoneNumberField({
    ...
    children: [
      IntlPhoneField(
        ...
        validator: (phone) => validator?.call(phone?.completeNumber),
  ...
  Widget _preferenceRadio(
    ...
    child: Row(
      children: [
        ...
        Text(title, style: const TextStyle(color: ColorConstants.primaryGrey)),
      ],
    ),
  );
}
